...
import { buildNubegenCommand } from './helper/nubegenCommandBuilder';
import { reporter } from '../../utils/reporter';
import { InstallationResponse } from '../../utils/models/installationResponse';

export default async function runNubesgen(
    ...
    const result = await longRunning(`Running Nubesgen.`, () => runNubesgenCommand(buildNubegenCommand()));
